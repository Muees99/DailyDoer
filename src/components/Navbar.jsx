...
//       {/* Mobile Menu Popup */}
//       {isMenuOpen && (
//         <div className="md:hidden fixed top-[4rem] right-0 bottom-0 left-0 bg-opacity-50 flex justify-end">
//           <div className="bg-slate-100 border border-gray-300 shadow-md py-2 px-4 rounded-md">
//             <button
